<template>
    <div class=" py-10">
        <div class="container mx-auto flex items-center flex-wrap pt-5 pb-[60px]">
            <!-- Store标题栏 -->
            <nav class=" w-full py-[5px] px-[30px]">
                <div class=" w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-[15px] px-[10px]">
                    <a href="#" class=" uppercase tracking-wide font-bold text-gray-800 text-xl">store</a>
                    <div class=" flex items-center">
                        <a href="#" class="pl-[15px] inline-block hover:text-black">
            ...
            <div class=" w-full md:w-1/3 xl:w-1/4 p-[30px] flex flex-col" v-for="(store,index) in stores" :key="index">
                <a href="#">
                    ...
                    <p class=" pt-[5px] text-gray-900">€9.99</p>
                </a>
            </div>
        </div>
    </div>
